...
| 6.3 LIVE | ⏳ Not yet run — needs `RESOURCE_REPORT_HOUR_UTC` set to the current hour on a real deployment with real accumulated data; blocked on the same Atlas connectivity outage as the other pending LIVE checks in this phase |
